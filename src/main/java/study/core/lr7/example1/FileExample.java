package study.core.lr7.example1;
...
public class FileExample {
	public static void main(String[] args) {
		File folder = new File("src/main/java/study/core/lr7/example1/example_folder");
		if (!folder.exists()) {
			if (folder.mkdir()) {
		...
		try {
			if (file.createNewFile()) {
				System.out.println("Файл создан: " + file.getAbsoluteFile());
			} else {
